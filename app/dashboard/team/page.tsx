...
import { 
  ...
  Shield, User, Crown, Trash2, Edit2, Send
} from "lucide-react";
...
const initialMembers = [
  { id: 1, name: "Agency Owner", email: "owner@agency.com", role: "Owner", status: "Active", joined: "Jan 2024", avatar: "AO" },
  { id: 2, name: "Sarah Khan", email: "sarah@agency.com", role: "Admin", status: "Active", joined: "Feb 2024", avatar: "SK" },
  { id: 3, name: "Ali Hassan", email: "ali@agency.com", role: "Member", status: "Active", joined: "Mar 2024", avatar: "AH" },
  { id: 4, name: "Zara Ahmed", email: "zara@agency.com", role: "Viewer", status: "Pending", joined: "May 2024", avatar: "ZA" },
];
          ...
          <DialogContent className="sm:max-w-md">
            ...
            <div className="space-y-4 pt-2">
              ...
              <div className="rounded-lg bg-muted p-3 text-sm text-muted-foreground">
                ...
                <p><strong>Member</strong> — Add/edit expenses only</p>
                ...
                >
                  <div className="flex items-center gap-3">
                    <Avatar className="h-9 w-9">
                      <AvatarFallback className="bg-indigo-100 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-400 text-sm font-semibold">
                        {member.avatar}
                      </AvatarFallback>
                    </Avatar>
                    <div>
