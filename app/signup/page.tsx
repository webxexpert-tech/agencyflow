      ...
      <div className="hidden lg:flex lg:w-1/2 bg-indigo-600 p-12 flex-col justify-between">
        ...
        <div>
          ...
          <p className="text-white/60 text-sm leading-relaxed">
            Join 500+ agency owners who track expenses, monitor cash flow, and grow smarter with AgencyFlow.
          </p>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        ...
        >
          ...
          <div className="mb-8">
            ...
            <p className="text-muted-foreground">Start tracking expenses in under 2 minutes</p>
          </div>

          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <div className="space-y-2">
              <Label htmlFor="name">Full Name</Label>
              <Input id="name" placeholder="Hasnain Shaikh"
                {...register("name")}
            ...
            <div className="space-y-2">
              ...
              <Input id="company" placeholder="WebX Digital Agency"
                {...register("company")}
            ...
            <Button type="submit" className="w-full h-11 mt-2 bg-indigo-600 hover:bg-indigo-700" disabled={loading}>
          ...
          <p className="text-center text-xs text-muted-foreground mt-4">
            ...
            <span className="text-indigo-600 cursor-pointer hover:underline">Terms</span>{" "}
            &{" "}
